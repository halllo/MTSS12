...
Der von Isis berechnete Softwarequalitätsindex" ist von mehreren Metriken abhängig. Im folgenden werden diese Metriken im Isis-Kontext so definiert, wie Kuhn sie auch in seinem Manuskript verwendet.
...
\end{definition}
\begin{definition}[Pakete in Zyklen] Pakete in Zyklen ist die Anzahl aller Namespaces, die Teil eines Namespace-Zyklus sind.
\end{definition}
\begin{definition}[Methoden mit hohem CC] Methoden mit hohem CC ist die Anzahl aller Methoden, deren zyklomatische Komplexität den Schwellwert 5 übersteigen.
\end{definition}
\begin{definition}[Average Component Dependency] ACD ist der gemittelte CCD-Wert aller Klassen und gibt an, wie viel Prozent aller Klassen von jeder Klasse direkt oder indirekt abhängig ist.
\end{definition}
\begin{definition}[Klassen mit vielen Methoden] Klassen mit vielen Methoden ist die Anzahl aller Klassen, die mehr als 20 Methoden haben.
\end{definition}
\begin{definition}[Große Methoden] Große Methoden ist die Anzahl aller Methoden, die mehr als 15 Codezeilen enthalten.
\end{definition}
\begin{definition}[Compiler-Warnungen] Compiler-Warnungen ist die Anzahl der Warnungen, die der Compiler beim Kompilieren anzeigt.
\end{definition}
...
\begin{tabular}{ l | c | c }
	...
	Methoden mit hohem CC & $\frac{\displaystyle m}{Anzahl Methoden}$ & $\frac{1}{50}$ \\
	Average Component Dependency & 1 & $100 \times Anzahl Klassen^{-1/3}$ \\
	Klassen mit vielen Methoden & $\frac{\displaystyle m}{Anzahl Klassen}$ & $\frac{1}{25}$ \\
...
\begin{tabular}{ l | c | c }
	...
	Methoden mit hohem CC & $\frac{\displaystyle RLOC}{Anzahl Methoden}$ & 15 \\
	Average Component Dependency & $\frac{\displaystyle RLOC}{Anzahl Klassen}$ & 200 \\
	Klassen mit vielen Methoden & $\frac{\displaystyle RLOC}{Anzahl Klassen}$ & 200 \\
...
\begin{tabular}{ l | c }
	...
	Methoden mit hohem CC & 1,75 \\
	Average Component Dependency & 1,58 \\
	Klassen mit vielen Methoden & 1,05 \\
	Große Methoden & 1,05 \\
