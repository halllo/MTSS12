...
\end{figure}
Dieses SQI-Fenster wurde bereits in Unterabschnitt \ref{subsec:ususnetsqi} beschrieben. Das ViewModel verwendet dafür ein Objekt vom Typ \texttt{SqiHistory}, mit dessen \texttt{Now}-Methode SQI-Werte, die einer Solution zugeordnet sind, gespeichert werden können.
...
Alle User Stories erfüllt. Oder?
Graphen Visualisierung weggelassen
Nur Analyse einer Verteilungsfunktion
