...
\end{equation}
Maximum Likelihood \url{http://mathworld.wolfram.com/MaximumLikelihood.html} Schätzer der Exponentialverteilung \url{http://mars.wiwi.hu-berlin.de/mediawiki/statwiki/index.php/Exponentialverteilung}
\begin{equation}
\lambda = \frac{n}{\sum_{i=1}^n x_i} = \frac{1}{\bar{x}}
\label{eq:edistributionml}
\end{equation}
Fällt gut $\lambda = 2$ \url{http://www.wolframalpha.com/input/?i=2e%5E%28-2x%29+x%3D0to10}
Fällt schlecht $\lambda = 0.2$ \url{http://www.wolframalpha.com/input/?i=0.2e%5E%28-0.2x%29+x%3D0to10}
Ergebnis= Mittelwert möglichst klein -> $\lambda$ möglichst groß
