...
\end{eqnarray*}
Formel \ref{eq:packageswithcyclicdependencies} zeigt dabei die Aufsummierung aller Pakete in einem Paket-Abhängigkeitsgraph, unter Verwendung eines Algorithmus zur Berechnung der starken Zusammenhangskomponenten, wie beispielsweise \textit{Starke Zusammenhangskomponenten}. Abschließend kann der $cyclicPackages$-Wert durch die Anzahl der betrachteten Pakete dividiert werden, um einen durchschnittlichen Paket-Zyklus-Wert zu bestimmen, der im Usus Cockpit angezeigt wird.
