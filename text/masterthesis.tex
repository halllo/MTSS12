...
welche Projekte gibt es, welches sind die Fenster, welches das Editor Paket und in welchem werden alle dann integriert?
...
{1} {2})*)\\)\$
\end{lstlisting}
Listing \ref{listing:methodregex2} zeigt die zweite Komponente des regulären Ausdrucks, welche die Sichtbarkeit einer Methode beschreibt.
...
\end{lstlisting}
Die dritte Komponente beschreibt die Syntax eines Typen und die vierte beschreibt einen Variablennamen. Beide Ausdrücke sind in Listing \ref{listing:methodregex3} abgebildet.
...
\end{lstlisting}
Im Gegensatz zu dem Menüpunkt, öffnet der Button das Fenster mit einem Parameter. Die Behandlung auf der Seite des Fensters muss also unabhängig davon funktionieren, ob eine Zeilen-Information übergeben wird oder nicht.
