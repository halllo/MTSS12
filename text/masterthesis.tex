...
\subsection{Umgebung}
Die Umgebung bla bla bla
\begin{enumerate}
	\item FxCop Regel und FxCop Runner, Jason Kresowaty \cite{FxCopCustomRules}
	\item Assembly-Ebene
	\item Multithreading -> jeder Thread sammelt seine eigenen Daten, nicht Thread-Save.
	\item ProblemCollection als Datenhaltung
	\item Problem bei Datenausgabe -> schlechte Lösung über Logs und neu-importieren, da Konsolidierung der Thread-Ergebnisse schwierig.
\end{enumerate}
\begin{figure}[h]
	\centering
