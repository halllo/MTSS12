...
\item[Usus Hotspots] todo
\begin{figure}[h]
	\centering
		\includegraphics[width=10cm]{images/usus_hotspots.png}
	\caption{Usus Hotspots todo}
	\label{fig:usus_hotspots}
\end{figure}
todo Abbildung \ref{fig:usus_hotspots}

\item[Usus Histogram] todo
\begin{figure}[h]
	\centering
		\includegraphics[width=10cm]{images/usus_histogram.png}
	\caption{Usus Histogram todo}
	\label{fig:usus_histogram}
\end{figure}
todo Abbildung \ref{fig:usus_histogram}

\item[Usus Class Graph \& Usus Package Graph] todo
\begin{figure}[h]
	\centering
		\includegraphics[width=10cm]{images/usus_graph.png}
	\caption{Usus Graph todo}
	\label{fig:usus_graph}
\end{figure}
todo Abbildung \ref{fig:usus_graph}
\end{description}
