...
Abbildung \ref{fig:architecture2} zeigt die Verwendung der in Kapitel \ref{chap:ususnet} beschrieben Funktionen von \texttt{Usus.net.Core}. \texttt{Usus.net.Core} steht als Bibliothek in Form einer Assembly zur Verfügung und wird von der Bibliothek \texttt{Usus.net.View} genutzt. Diese Bibliothek enthält alle grafischen Oberflächen von Usus.net und wird von der \texttt{Usus.net} Visual Studio Erweiterung verwendet. Die Erweiterung stellt dann nur noch die Fenster-Infrastruktur für die Usus.net Oberflächen zur Verfügung. In diesem Kapitel werden zunächst die Steuerelemente von \texttt{Usus.net.View} vorgestellt. Anschließend wird auf die Integration mit Visual Studio eingegangen.
...
\begin{figure}[h]
	...
	\caption{Usus.net Clean Code Grade}
...
DtAwareToolWindow mit MasterObjekt dt2

SolutionAwareToolWindowPane mit RawSolution EnvDTE.Solution, RawProjects IEnumerable<EnvDTE.Project> und Projects IEnumerable<Project>

SolutionEventsAwareToolWindowPane mit Ereignissen SolutionChanged, SavingDone, CommandDone, BuildStart, BuildDone

BuildAwareToolWindowPane mit Ereignis BuildSuccessfull und Parameter IEnumerable<string>
