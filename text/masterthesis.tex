...
\begin{lstlisting}[caption={\textit{CCI Code and AST Components} \texttt{CodeTraverser}-Methods},label={listing:ccicodeastsample}]
...
AST aus Quelltext 
AST-Besucher
If-Anweisungen sehr gut besuchbar

kein Method Bindung, da nichts kompiliert :( (Extension Methods?)
Resolver und Kompilierer von Mono.Cecil...
