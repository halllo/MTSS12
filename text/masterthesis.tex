...
\begin{figure}[h]
	...
	\label{fig:usecases}
\end{figure}
Abbildung \ref{fig:usecases} zeigt die Anwendungsfälle, die sich aus den Zielen in Abschnitt \ref{sec:goals} ergeben.

TODO:
Clean Code entwickeln -> Clean Code Hinweis bekommen
.NET Entwickler -> Clean Code Verbindung entfernen
Use Case Diagramm für Thesis-Leser (Technologie Evaluation)
