...
\end{table}
In diesem Abschnitt wurden die Parameter beschrieben, mit denen Isis den \gls{SQI} berechnet. Die nachfolgenden Abschnitte beschäftigen sich damit wie die Berechnung des \glslink{SQI}{SQI} in Usus.NET durchgeführt werden kann.
