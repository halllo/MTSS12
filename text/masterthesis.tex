...
Eine sehr interessante Metrik im NDepend Metrik-Portfolio ist "`Abstraktheit und Instabilität"'. Robert C. Martin stellt in seinem Artikel \cite{OODesignMetrics} folgende Metriken vor.
...
Diagramm mit "`Zone der Nutzlosigkeit"' und "`Zone der Qual"'
...
\section{CCD-Addin}
Die Grade direkt in der IDE, immer sichtbar.
\url{http://blog.alexonasp.net/post/2009/02/21/Clean-Code-Developer-e28093-das-Visual-Studio-Add-In.aspx}
