...
\subsection{API}
Die FxCop API bla bla bla Microsoft.FxCop.Sdk bla bla
\begin{enumerate}
	\item wie System.Reflection
	\item Visitor Pattern
	\item Check Member, TypeNode, ModulNode, Parameter, Resource, TypeNodeCollection
	\item Visit Assingment, Branch, MemberBinding (Methodenaufruf), TypeNode, ModulNode, Parameter, Resource, TypeNodeCollection
	\item Visitor Pattern
\end{enumerate}
