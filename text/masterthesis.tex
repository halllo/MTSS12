...
\chapter{In Aktion}
\label{chap:inaction}
Messungen von verschiedenen Open Source Projekten und Beispielprogrammen zuerst mit Usus.net, dann NDepend, dann Sotograph
\textcolor[rgb]{1,0,0}{todo}


\section{Metrik-Vergleich}
Stimmen die Werte, die Usus.net bestimmt mit denen der anderen Werkzeuge überein? Usus.net, dann NDepend, dann Sotograph, dann Code Metrics PowerTool
\textcolor[rgb]{1,0,0}{todo}
...
\textcolor[rgb]{1,0,0}{todo}
PLINQ is faster than task for every assembly
\\
pdb-Files verhalten sich komisch bei parallelem einlesen. Bei erneutem Kompilieren entstehen Phantom-Änderungen, sprich Methodenlängen werden anders gelesen.
\\
pdb-Files werden nicht rechtzeitig freigegeben bei zu schnellen wiederholten Kompilieren.
