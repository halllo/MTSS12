...
In diesem Unterabschnitt werden die Möglichkeiten beschrieben, wie der Syntax-Baum der Compiler API verwendet werden kann.
...
\begin{lstlisting}[caption={bla},label={listing:bla1}]
...
\subsection{Semantik}
In diesem Unterabschnitt wird beschrieben, wie die Compiler API die Semantik von Code verwaltet. Nach der Erzeugung der syntaktischen Repräsentation von Code, dem Syntax Tree, ...

\begin{lstlisting}[caption={bla},label={listing:bla2}]
...
\begin{lstlisting}[caption={bla},label={listing:bla3}]
...
In diesem Unterabschnitt werden die Möglichkeiten der Compiler API in Bezug auf die Analyse von ganzen Solutions beschrieben.
Solution Level Analysis

\begin{lstlisting}[caption={bla},label={listing:bla4}]
