...
In diesem Abschnitt werden einige Werkzeuge vorgestellt, die bereits eine statische Code-Analyse durchführen um Metriken einer Codebasis zu bestimmen.

\subsection{Visual Studio Metrics}
Die Entwicklungsumgebung unterstützt bereits verschieden Ansätze Code Metriken zu bestimmen. In diesem Unterabschnitt sollen einige bekannte Möglichkeiten beschrieben werden.
