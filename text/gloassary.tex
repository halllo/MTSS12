...
\newglossaryentry{SQI}
{
   ...
   description={ist eine \gls{Metrik} eines Softwareprogramms, die verschiedene \glslink{Metrik}{Metriken} des Systems kombiniert und auf einen Wert reduziert. Je höher der Softwarequalit\"atsindex, desto höher ist auch die innere Qualität der Software}
}