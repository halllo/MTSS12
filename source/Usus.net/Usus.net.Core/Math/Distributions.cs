...
namespace andrena.Usus.net.Core.Math
{
    public static class Distributions
    {
        ...
        public static IHistogram TypeDistribution(this MetricsReport metrics, Func<TypeMetricsReport, int> selector)
        {
            return new Distribution(metrics.TypesNotGenerated(selector));
        }

        public static IHistogram MethodDistribution(this MetricsReport metrics, Func<MethodMetricsReport, int> selector)
        {
            return new Distribution(metrics.MethodsNotGenerated(selector));
        }

        public static IHistogram NamespaceDistribution(this MetricsReport metrics, Func<NamespaceMetricsReport, int> selector)
        {
