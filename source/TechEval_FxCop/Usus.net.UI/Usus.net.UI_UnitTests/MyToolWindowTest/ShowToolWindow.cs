...
namespace Usus.net.UI_UnitTests.MyToolWindowTest
{
    [TestClass()]
    public class ShowToolWindowTest
    {
        ...
        {
            IVsPackage package = new Usus_net_UIPackage() as IVsPackage;
            ...
            MethodInfo method = typeof(Usus_net_UIPackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
